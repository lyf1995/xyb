...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../css/StudentCss/searchPosts.css">
	...
	<script type="text/javascript" src="../../js/StudentJs/searchPosts.js"></script>
		...
		<c:forEach var="postPojo" items="${postPojos}">
			<div class="post-show-box" data-postid="${postPojo.id }">
				<div class="operation-show clearfix">
					<a href="searchPostsDetailed.html?postId=${postPojo.id }" class="a-danger a-big searchPostsDetailed">查看岗位详情</a>
					<c:if test="${postPojo.has=='no'}"><a href="javascript:;" class="a-danger a-big postResume">投递简历</a></c:if>
					<c:if test="${postPojo.has=='yes'}"><a href="javascript:;" class="a-has a-big">已经投递</a></c:if>
				</div>
				...
				<div class="post-show-top">
					...
					<div class="post-show-salary">${postPojo.postSalary }元/月</div>
