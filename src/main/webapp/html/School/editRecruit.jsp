...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../css/SchoolCss/editRecruit.css">
	...
	<script type="text/javascript" src="../../js/SchoolJs/editRecruit.js"></script>
...
<div id="middle" class="middle-1200 clearfix">
	<div class="middle-box clearfix padding">
		<form id="post-form" class="form-inline" action="editRecruit.html?recruitId=${recruitPojo.id }" autocomplete method="post">
			<div class="post-form-div">
				<ul>
					<li class="clearfix"> 
						<label>校招名称：</label>
						<input id="name" type="text" name="recruitName" value="${recruitPojo.recruitName }" placeholder="校招名称" class="form-control">
					</li>
					<li class="clearfix"> 
   						<div class="wrap-date">
							<label>校招时间：</label>
							<input id="startTime" readonly  type="text" name="startTimeStr" value="${recruitPojo.startTimeStr }" placeholder="开始日期" class="form-control date_picker" required>
						</div>
						<div class="wrap-date">
							<label>至：</label>
							<input id="endTime" readonly  type="text" name="endTimeStr" value="${recruitPojo.endTimeStr }" placeholder="结束日期" class="form-control date_picker" required>
						</div>
					</li>
					<li>
						<label>详细地址：</label>
						<input id="address" type="text" name="address" value="${recruitPojo.address }" placeholder="详细地址" class="form-control">
					</li>
					<li>
						<label style="vertical-align: top;">校招简介：</label>
						<textarea id="RecruitDetail" type="text" name="recruitDetail" placeholder="校招简介" class="form-control">${recruitPojo.recruitDetail }</textarea>
					</li>
...
<input id="editStatus" type="hidden" value="${editStatus }">
</body>
<script>
window.onload=function(){
	var editStatus=document.getElementById("editStatus").value;
	if(editStatus=="sucess"){
		alert("修改成功");
	}
}
</script>
